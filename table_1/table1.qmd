...
This code takes our armed conflict data and attempts to create a "Table 1" to introduce readers to the data. I decided to aggregate data by country and year and look at our continuous variables and outcomes as means and SD, stratified by conflict (binary). I also attempted to organize it in a way where mean and SD calculations exist in the same cell using the paste() function.
